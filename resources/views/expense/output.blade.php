        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Cadastro de Conta Saída</div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/expense/output/create') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('pricetotal') ? ' has-error' : '' }}">
                                <label for="pricetotal" class="col-md-4 control-label">Valor Total:</label>

                                <div class="col-md-6">
                                    <input id="pricetotal" type="number" class="form-control" name="pricetotal" value="{{ old('pricetotal') }}" required>
                                    @if ($errors->has('pricetotal'))
                                        <span class="help-block">
                                        <strong>{{ $errors->first('pricetotal') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
