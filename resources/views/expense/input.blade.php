            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/expense/input/create') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="name" class="form-control" name="name" value="{{ old('name') }}" required>
                                        <option>Selecione uma pessoa</option>
                                        @forelse($cities as $user)
                            ...
                            <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="category" type="text" class="form-control" name="category" value="{{ old('category') }}" required>
                                        <option>Selecione um tipo de oferta</option>
                                        <option value="0">Dizimo</option>
                                        <option value="1">Oferta</option>
                                        <option value="2">Culto</option>
